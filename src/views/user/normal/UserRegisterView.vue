  ...
  <div class="register-wrapper">
    <div class="register-container">
      ...
      <form @submit.prevent="handleRegister" class="floating-form">
        ...
        <div class="input-group">
          <input type="password" id="password" v-model="userPassword" required minlength="8" maxlength="20"/>
          <label for="password">密码</label>
          <span class="highlight"></span>
        </div>
        <div class="input-group">
          <input type="password" id="confirmPassword" v-model="checkPassword" required minlength="8" maxlength="20"/>
...
import {getCode, userRegister} from "@/api/user/index.ts";
